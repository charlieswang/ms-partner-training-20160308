...
chartSeries(to.daily(Xt), theme = "white")
addCCI()
addBBands()
...
chartSeries(Xt["2015-11-11"], theme = "white")
chartSeries(to.minutes(Xt["2015-11-11"]), theme = "white")
chartSeries(to.minutes10(Xt["2015-11-11"]), theme = "white")
